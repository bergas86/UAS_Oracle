              ...
              <form class="form-horizontal" action="add_barang.php" method="post">
               <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" name="id_brng" placeholder="Masukan Kode Barang">
                </div>
                <div class="form-group col-md-6">
                  <label for="">NAMA BARANG</label>
                  <input type="text" class="form-control" name="nm_brng" placeholder="Masukan Nama Barang">
                </div>
                <div class="form-group col-md-6">
                  <label for="">HARGA BARANG</label>
                  <input type="text" class="form-control" name="harga" placeholder="Masukan Nama Barang">
                </div>
                <div class="form-group col-md-6">
